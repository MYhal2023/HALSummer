...
#define ENEMY_OFFSET_Y		(10.0f)							// プレイヤーの足元をあわせる
...
static EnemyParts	g_Parts[MAX_ENEMY * 2];					// エネミーのパーツ。余裕をもってエネミー×2倍の数用意
